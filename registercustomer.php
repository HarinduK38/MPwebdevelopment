...
$sql="INSERT INTO `customers` (`customer_id`, `password`, `given_name`, `family_name`, `phone_num`) VALUES ('".$_POST["username"]."', '".$_POST["password"]."', '".$_POST["firstname"]."', '".$_POST["lastname"]."', '".$_POST["phonenum"]."')";
$result=$conn_to_harindu->query($sql);
echo "Successfull Registration !<br>";
echo "Login !";
?>
