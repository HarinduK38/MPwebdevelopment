...
<form action = "registercustomer.php" method = "post">
					...
					<input type="text" placeholder="Enter Username" name="username" minlength ="8" required>
					<br>
					<label for="password"><b>password</b></label>
					<input type="password" placeholder="Enter password" name="password" required>
					<br>
					<label for="firstname"><b>Firstname</b></label>
					<input type="text" placeholder="Enter GivenName" name="firstname" required>
					<br>
					<label for="lastname"><b>Lastname</b></label>
					<input type="text" placeholder="Enter FamilyName" name="lastname" required>
					<br>
